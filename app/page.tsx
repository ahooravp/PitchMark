...
async function HomeContent({ searchParamsPromise }: { searchParamsPromise: Promise<{ query?: string }> }) {
  ...
  return (
    <>
      ...
      <section className="section_container">
        ...
        <Suspense fallback={<p className="text-20-regular">Loading startups...</p>}>
