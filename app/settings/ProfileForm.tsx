...
import { AUTHOR_BY_ID_QUERY_RESULT } from "@/sanity.types";

type UserProfile = NonNullable<AUTHOR_BY_ID_QUERY_RESULT>;
    ...
    <form action={handleClientAction} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          />
          <p className="text-xs text-black-100/70 mt-2 font-medium">
        ...
        <div>
          ...
          />
          <p className="text-xs text-black-100/70 mt-2 font-medium">
            Linked to your sign-in provider.
          </p>
        </div>
      </div>
      ...
      <div>
        <label
          htmlFor="name"
          className="block text-sm font-medium text-black-200 mb-2"
        >
          Display Name
        </label>
        <input
